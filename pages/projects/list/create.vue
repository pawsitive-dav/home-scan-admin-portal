          ...
          <v-row>
            ...
            <v-col cols="12">
              <cp-card class="pa-6">
                ...
                <v-text-field
                  v-model="projectCoordinator.email1"
                  :disabled="loading"
                  dense
                  outlined
                  required
                ...
                <v-text-field
                  v-model="projectCoordinator.email2"
                  :disabled="loading"
                  dense
                  outlined
                  required
                ...
                <v-text-field
                  v-model="projectCoordinator.email3"
                  :disabled="loading"
                  dense
                  outlined
                  required
...
export default {
  ...
  methods: {
    ...
    async onCreateProject() {
      ...
      const accessToken = await this.getAccessToken()
      if (accessToken) {
        const groupCustomerEmail = [this.customerDetail.email1, this.customerDetail.email2, this.customerDetail.email3].filter(email => email).join(",");
        const groupCoordinatorEmail = [this.projectCoordinator.email1, this.projectCoordinator.email2, this.projectCoordinator.email3].filter(email => email).join(",");
        const dataSetup = {
          project_detail: {
          ...
          customer_detail: {
            ...
            customer_email: groupCustomerEmail || null,
          },
          project_coordinator: {
            ...
            coordinator_email: groupCoordinatorEmail || null,
          },
          project_teams: {
